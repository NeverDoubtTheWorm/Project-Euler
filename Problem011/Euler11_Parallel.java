...
public class Euler11 {
    public static long getLargestProduct(int[][] grid, int digits){
        ...
        //Queue to hold factors of my current product
        FactorQueue adjQueue1 = new FactorQueue(digits);
        FactorQueue adjQueue2 = new FactorQueue(digits);
        ...
        for( int i = 0; i < length; i++ ) {
            ...
            // iterating through all left-right adjacent lists of size digits
                value = grid[i][j];
                adjQueue1.offer( value );
            // iterating through all up-down adjacent lists of size digits
                value = grid[j][i];
                adjQueue2.offer( value );
            }
        }

        // traverse middle diagonal and anti-diagonal
        adjQueue1.flush();
        adjQueue2.flush();
        for(int i = 0; i < length; i++ ){
            value = grid[i][i];
        ...
        return ( adjQueue1.getMax() > adjQueue2.getMax() )? adjQueue1.getMax() : adjQueue2.getMax();
    }
